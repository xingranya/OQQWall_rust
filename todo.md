...
- [ ] Replace the render stub with a real SVG renderer per `docs/typesetting&render.md`, plus optional PNG conversion.
...
## P1 - Productization
- [ ] Add admin web UI endpoints (queue/status, SVG preview, blob fetch) using axum.
...
- [ ] Add safety checks for SVG output (escape text, sanitize URLs, stable layout).
